...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CTree : CTree.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CTree*, int, uint>)(lpVtbl[6]))((CTree*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CTree*, uint, uint, void>)(lpVtbl[7]))((CTree*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CTree*, uint, void>)(lpVtbl[8]))((CTree*)Unsafe.AsPointer(ref this), param0);
        }

...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CPile : CPile.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CPile*, int, uint>)(lpVtbl[6]))((CPile*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CPile*, uint, uint, void>)(lpVtbl[7]))((CPile*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CPile*, uint, void>)(lpVtbl[8]))((CPile*)Unsafe.AsPointer(ref this), param0);
        }

...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct IDecoObject : IDecoObject.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<IDecoObject*, int, uint>)(lpVtbl[6]))((IDecoObject*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IDecoObject*, uint, uint, void>)(lpVtbl[7]))((IDecoObject*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IDecoObject*, uint, void>)(lpVtbl[8]))((IDecoObject*)Unsafe.AsPointer(ref this), param0);
        }

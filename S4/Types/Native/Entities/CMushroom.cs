...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CMushroom : CMushroom.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CMushroom*, int, uint>)(lpVtbl[6]))((CMushroom*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CMushroom*, uint, uint, void>)(lpVtbl[7]))((CMushroom*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CMushroom*, uint, void>)(lpVtbl[8]))((CMushroom*)Unsafe.AsPointer(ref this), param0);
        }

...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CShadowHerb : CShadowHerb.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CShadowHerb*, int, uint>)(lpVtbl[6]))((CShadowHerb*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CShadowHerb*, uint, uint, void>)(lpVtbl[7]))((CShadowHerb*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CShadowHerb*, uint, void>)(lpVtbl[8]))((CShadowHerb*)Unsafe.AsPointer(ref this), param0);
        }

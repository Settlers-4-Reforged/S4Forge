...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CAnimal : CAnimal.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CAnimal*, int, uint>)(lpVtbl[6]))((CAnimal*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CAnimal*, uint, uint, void>)(lpVtbl[7]))((CAnimal*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CAnimal*, uint, void>)(lpVtbl[8]))((CAnimal*)Unsafe.AsPointer(ref this), param0);
        }

...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct IFlyingEntity : IFlyingEntity.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<IFlyingEntity*, int, uint>)(lpVtbl[6]))((IFlyingEntity*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IFlyingEntity*, uint, uint, void>)(lpVtbl[7]))((IFlyingEntity*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IFlyingEntity*, uint, void>)(lpVtbl[8]))((IFlyingEntity*)Unsafe.AsPointer(ref this), param0);
        }

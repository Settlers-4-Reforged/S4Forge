...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CStone : CStone.Interface
    {
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStone*, uint, uint, void>)(lpVtbl[7]))((CStone*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStone*, uint, void>)(lpVtbl[8]))((CStone*)Unsafe.AsPointer(ref this), param0);
        }

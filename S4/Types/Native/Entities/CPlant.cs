...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CPlant : CPlant.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CPlant*, int, uint>)(lpVtbl[6]))((CPlant*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CPlant*, uint, uint, void>)(lpVtbl[7]))((CPlant*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CPlant*, uint, void>)(lpVtbl[8]))((CPlant*)Unsafe.AsPointer(ref this), param0);
        }

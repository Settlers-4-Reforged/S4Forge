...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CHive : CHive.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CHive*, int, uint>)(lpVtbl[6]))((CHive*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CHive*, uint, uint, void>)(lpVtbl[7]))((CHive*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CHive*, uint, void>)(lpVtbl[8]))((CHive*)Unsafe.AsPointer(ref this), param0);
        }

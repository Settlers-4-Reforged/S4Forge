...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CWheeler : CWheeler.Interface
    {
        ...
        {
            ((delegate* unmanaged[Thiscall]<CWheeler*, uint, uint, void>)(lpVtbl[7]))((CWheeler*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CWheeler*, uint, void>)(lpVtbl[8]))((CWheeler*)Unsafe.AsPointer(ref this), param0);
        }

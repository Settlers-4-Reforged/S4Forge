...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CShip : CShip.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CShip*, int, uint>)(lpVtbl[6]))((CShip*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CShip*, uint, uint, void>)(lpVtbl[7]))((CShip*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CShip*, uint, void>)(lpVtbl[8]))((CShip*)Unsafe.AsPointer(ref this), param0);
        }

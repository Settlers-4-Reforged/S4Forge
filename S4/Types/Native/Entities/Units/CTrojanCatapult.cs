...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CTrojanCatapult : CTrojanCatapult.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CTrojanCatapult*, int, uint>)(lpVtbl_Base1[6]))((CTrojanCatapult*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CTrojanCatapult*, uint, uint, void>)(lpVtbl_Base1[7]))((CTrojanCatapult*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CTrojanCatapult*, uint, void>)(lpVtbl_Base1[8]))((CTrojanCatapult*)Unsafe.AsPointer(ref this), param0);
        }

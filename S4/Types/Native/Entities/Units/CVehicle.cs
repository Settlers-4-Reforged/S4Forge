...
namespace Forge.S4.Types.Native.Entities
{
    ...
    public unsafe partial struct CVehicle : CVehicle.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CVehicle*, int, uint>)(lpVtbl[6]))((CVehicle*)Unsafe.AsPointer(ref this), param0);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CVehicle*, uint, uint, void>)(lpVtbl[7]))((CVehicle*)Unsafe.AsPointer(ref this), param0, param1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CVehicle*, uint, void>)(lpVtbl[8]))((CVehicle*)Unsafe.AsPointer(ref this), param0);
        }
